    ...
    <>
      <div className="relative w-full h-screen">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white z-10">
          ...
          <form className="w-full max-w-2xl mt-24 px-6 md:px-0">
            <div className="mb-8">
              <input
                type="text"
                name="name"
                placeholder="Imię i nazwisko"
                className="w-full bg-transparent border-0 border-b-2 border-white/50 text-white placeholder-white/70 py-3 px-0 focus:border-orange focus:outline-none transition-colors duration-300 text-lg"
              />
            </div>
            <div className="mb-8">
              <input
            ...
            <div className="mb-8">
              <textarea
                ...
                className="w-full bg-transparent border-0 border-b-2 border-white/50 text-white placeholder-white/70 py-3 px-0 focus:border-orange focus:outline-none transition-colors duration-300 resize-none text-lg"
              ></textarea>
            </div>
            <div className="text-center">
              <button type="submit" className=" font-bold px-16 py-3 rounded-lg transition">
                Wyślij
              </button>
            </div>
          </form>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-text-muted">
                  <a href="tel:+48343628633" className=" transition-colors">
                    +48 34 362 86 33
                  </a>
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-text-muted">
                  <a href="mailto:kontakt@grandmasterchess.pl" className=" transition-colors">
